# Test-Only Helper Script: Generates JWTs for local testing purposes only.
# DO NOT USE THIS SCRIPT OR TOKENS IN PRODUCTION ENVIRONMENTS.
...
payload = {
    ...
    "iat": now,
    "iss": f"{SUPABASE_URL}",
    "note": "LOCAL TEST TOKEN - NOT FOR PRODUCTION"
}
...
try:
    ...
    print("⚠️  GENERATED TEST TOKEN (do not use in production):")
    print(token)
