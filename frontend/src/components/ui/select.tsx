...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl px-4 py-3 text-base transition-all duration-200",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-[300px] min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-xl",
          "bg-[#1A1A1A] border border-white/10 text-white shadow-xl backdrop-blur-xl",
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-[#D4A574]" />
        </SelectPrimitive.ItemIndicator>
      </span>
