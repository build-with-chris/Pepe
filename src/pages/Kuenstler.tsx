  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.log('🎨 Kuenstler - API URL:', url, 'Artists loaded:', rawList.length, 'Raw data:', rawList);
  ...
  useEffect(() => {
    ...
    return (
      <div>
        ...
        {/* Artists Filter and Grid Section */}
        <section className="section">
          <div className="stage-container">
                    ...
                    {DISCIPLINE_ITEMS.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`btn btn-sm transition-all focus:outline-none focus:ring-2 focus:ring-white/40 focus:ring-offset-0 ${
                            active
                              ? "btn-primary"
                              : "btn-ghost"
                          }`}
